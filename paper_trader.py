...
def get_latest_intraday_date(intraday):
...
def run_decision():
    ...
    if new_positions:
        ...
        status.get("long_break", 0) == 0

        and

        status.get("short_break", 0) == 0
