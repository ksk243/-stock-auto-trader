...
#   Cloud RunではGCSへアップロード

#

#   latest_result.txt もGCSへアップロード
...
if len(TICKERS) != 137:
    ...
    raise RuntimeError(
        ...
        f"Universe error: expected 137 tickers, "
        ...
        try:
            ...
            subprocess.run(
                ...
                [
                    ...
                    f"gs://{GCS_BUCKET}/{GCS_RESULT_PATH}"
            ...
            print(
                ...
                "GCS latest_result.txt upload completed"
            ...
            print(
                ...
                f"GCS latest_result.txt upload failed: {e}"
