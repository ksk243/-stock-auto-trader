...
def run_decision():
    ...
    lines.append(
        ...
        f"{get_max_value(equity, 'LONG'):,.0f}"
    ...
    lines.append(
        ...
        f"{get_max_value(equity, 'SHORT'):,.0f}"
